...
class PlayingHighlightedCard(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # painter.setPen(QPen(QColor(255, 0, 0), self.size[0] / 36, join=Qt.PenJoinStyle.RoundJoin))
...
if __name__ == "__main__":
    ...
    ex = PlayingHighlightedCard(size=(600, 900), num=47)
